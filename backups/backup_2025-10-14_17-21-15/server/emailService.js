    ...
    try {
        ...
        const emailPayload = {
            message: {
                ...
                toRecipients: [
                    { emailAddress: { address: "exelonhelpdesk@exelonglobal.com" } }
                ],
                ccRecipients: [
                    { emailAddress: { address: "hrhelpdesk@exelonglobal.com" } } // Example CC recipient
...
module.exports = { sendNewHireEmail };