import React, { useState, useEffect, useRef } from 'react';
      ...
      const courierTrackingUrls = {
          "DTDC": "https://www.dtdc.in/tracking/tracking_results.asp?trackno=",
          "Blue Dart": "https://www.bluedart.com/tracking?trackno=",
      };
      ...
      const DeliveryTracker = () => {
         ...
         const handleTrackDelivery = (courierPartner, trackingNumber) => {
            const baseUrl = courierTrackingUrls[courierPartner];
            if (baseUrl && trackingNumber) {
                window.open(`${baseUrl}${trackingNumber}`, '_blank');
            } else if (courierPartner === "Shakdakshri") {
                alert("Shakdakshri is for in-person delivery, no tracking URL available.");
            } else {
                alert(`Tracking URL not available for ${courierPartner} or missing tracking number.`);
            }
        };
            ...
            <div className="container-fluid mt-4">
                                ...
                                {sortedAndFilteredDeliveries.map(delivery => (
                                    <tr key={delivery.id}>
                                        ...
                                        <td>
                                            ...
                                            {delivery.tracking_number && delivery.courier_partner && (
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye-fill track-icon" viewBox="0 0 16 16"
                                                    onClick={() => handleTrackDelivery(delivery.courier_partner, delivery.tracking_number)}
                ...
                <Modal show={showModal} onHide={handleCloseModal}>
                    <Modal.Header closeButton>
                        <Modal.Title>{editingDeliveryId ? "Edit Delivery" : "Add New Delivery"}</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="text" className="form-control" id="address" name="address" value={newDelivery.address} onChange={handleInputChange} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="asset_type" className="form-label">Asset Type</label>
                                    <select className="form-select" id="asset_type" name="asset_type" value={newDelivery.asset_type} onChange={handleInputChange}>
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="text" className="form-control" id="mobile_number" name="mobile_number" value={newDelivery.mobile_number} onChange={handleInputChange} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="courier_partner" className="form-label">Courier Partner</label>
                                    <select className="form-select" id="courier_partner" name="courier_partner" value={newDelivery.courier_partner} onChange={handleInputChange}>
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="text" className="form-control" id="tracking_number" name="tracking_number" value={newDelivery.tracking_number} onChange={handleInputChange} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="courier_date" className="form-label">Courier Date</label>
                                    <input type="date" className="form-control" id="courier_date" name="courier_date" value={newDelivery.courier_date} onChange={handleInputChange} />
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="it_status" className="form-label">IT Status</label>
                                    <select className="form-select" id="it_status" name="it_status" value={newDelivery.it_status} onChange={handleInputChange}>
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <select className="form-select" id="final_status" name="final_status" value={newDelivery.final_status} onChange={handleInputChange}>
                                ...
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="date" className="form-control" id="delivery_date" name="delivery_date" value={newDelivery.delivery_date} onChange={handleInputChange} />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="new_joiner" className="form-label">New Joiner</label>
                                    <select className="form-select" id="new_joiner" name="new_joiner" value={newDelivery.new_joiner} onChange={handleInputChange}>
                            ...
                            <Button variant="primary" type="submit">
                                {editingDeliveryId ? "Update Delivery" : "Add Delivery"}
                            </Button>
