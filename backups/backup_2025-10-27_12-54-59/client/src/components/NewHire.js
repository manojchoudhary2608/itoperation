...
const NewHire = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const dataToSend = { ...formData, addedBy: username };
    ...
    const getStatusStyle = (status) => {
        switch (status) {
            case 'Open':
                return { backgroundColor: '#1D2951', color: 'white', fontWeight: 'bold' };
            case 'Called Off':
    ...
    return (
        <Container fluid className="mt-4">
            <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <div className="new-hire-buttons">
                ...
                <tbody>
                    {sortedAndFilteredNewHires.map(hire => (
                        <tr key={hire.id}>
                            ...
                            <td style={getStatusStyle(hire.status)}>{hire.status}</td>
