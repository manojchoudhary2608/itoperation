...
const JWT_SECRET = process.env.JWT_SECRET || "your_jwt_secret_key"; // In a real app, use an environment variable
...
app.post("/api/login", (req, res) => {
    ...
    db.get(sql, [username], (err, user) => {
        console.log("User object from database on login:", user);
        if (err) {
